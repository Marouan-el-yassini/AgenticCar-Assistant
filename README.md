...
1. **[Booking Process & Lead Qualification](./docs/README_Booking_Lead_Qualification.md)**
...
2. **[Service Client (Customer Support) Agent](./docs/README_Service_Client_Agent.md)**
...
3. **[LLM Audio Processing: TTS & STT](./docs/README_LLM_TTS_STT.md)**
...
4. **[Client Management & Expiry Notifications](./docs/README_Client_Management.md)**
...
![Main Workflow Screen](./images/CaptureEcran.jpg)

### Client Management & Expiry Scheduler
![Client Management Screen](./images/ClientMangement.jpg)
